...
class HajjScreen extends StatelessWidget {
  ...
  final List<Item> hajj_types = [
    Item(
      number: "1",
      text:
          "حج التمتع: أفضل الأنساك عند الجمهور. وهو أن يُحرم بالعمرة في أشهر الحج (شوال أو ذي القعدة أو عشر ذي الحجة)، ويُحل منها، ثم يُحرم بالحج يوم التروية (8 ذي الحجة) من مكة. وعليه هدي (ذبح شاة أو سبع بدنة أو بقرة).",
    ),
    Item(
      number: "2",
      text:
          "حج القِران: أن يُحرم بالعمرة والحج معًا من الميقات، ويبقى على إحرامه إلى يوم النحر. وعليه هدي كالمتمتع.",
    ),
    Item(
      number: "3",
      text:
          "حج الإفراد: أن يُحرم بالحج فقط من الميقات، ويبقى على إحرامه حتى يوم النحر، ثم بعد التحلل يؤدي العمرة إن شاء. وليس عليه هدي.",
    ),
    Item(
      number: "4",
      text: "يُستحب التمتع للقادر على الهدي، وهو ما سنعتمد في شرح الخطوات.",
    ),
  ];

...
class ManasekScreen extends StatelessWidget {
  ...
  final List<Item> hajjMiqat = [
    Item(
      number: "1",
      text:
          "ذو الحليفة (أبيار علي): ميقات أهل المدينة ومن مرَّ بها، وهو أبعد المواقيت عن مكة.",
    ),
    Item(
      number: "2",
      text:
          "الجُحفة: ميقات أهل الشام ومصر والمغرب، ويحرم الناس اليوم غالبًا من رابغ القريبة منها.",
    ),
    Item(
      number: "3",
      text: "قَرن المنازل (السيل الكبير): ميقات أهل نجد ومن جاء من جهتهم.",
    ),
    Item(number: "4", text: "يَلملم: ميقات أهل اليمن ومن جاء من جهتهم."),

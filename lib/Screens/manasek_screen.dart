...
class ManasekScreen extends StatelessWidget {
  ...
  final List<Item> hajjUmrahconditions = [
    Item(
      number: "1",
      title: "الإسلام",
      text: " فلا يجب الحج ولا العمرة على الكافر.",
    ),
    Item(number: "2", title: "العقل", text: " فلا يجبان على المجنون حتى يفيق."),
    Item(
      number: "3",
      title: "البلوغ",
      text: " لا يجبان على الصغير، وإن حج صح حجه نفلاً.",
    ),
    Item(
      number: "4",
      title: "الحرية",
      text: " من شروط الوجوب عند جمهور الفقهاء.",
    ),
    Item(
      number: "5",
      title: "الاستطاعة",
      text: " وهي القدرة البدنية والمالية وأمن الطريق.",
    ),
    Item(
      number: "6",
      title: "مَحرَم للمرأة",
      text: "وجود المحرم للمرأة عند من اشترطه من أهل العلم.",
    ),
  ];
  ...
  final List<Item> hajjMiqat = [
    ...
    Item(
      number: "5",
      title: " ذات عرق",
      text: " ميقات أهل العراق ومن جاء من جهتهم.",
    ),
    Item(
      number: "ملاحظة",
      text:
    ...
    Item(
      number: "ملاحظة",
      text:
          "العمرة لأهل مكة فيُحرمون بها من الحِلّ، كالتنعيم أو الجعرانة ونحوهما",
    ),
  ];
  ManasekScreen({
    super.key,
